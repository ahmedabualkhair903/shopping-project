...
export default function ProductsError({
  ...
  useEffect(() => {
    if (error) {
      ...
      console.error(
        "Products page error: Unknown error"
      );
    }
  }, [error]);
    ...
    <main className="min-h-[75vh] bg-[#f8f8f6] text-[#252c30]">
      <section className="relative flex min-h-[75vh] items-center justify-center overflow-hidden px-5 py-16 sm:px-8 lg:px-10">
        ...
        <div className="relative z-10 w-full max-w-xl text-center">
          ...
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-[24px] border border-[#e5e9e8] bg-white text-[#b27a58] shadow-[0_15px_45px_rgba(37,44,48,0.06)]">
            <FiAlertCircle
              size={30}
              strokeWidth={1.25}
            />
          ...
          <p className="mx-auto mt-5 max-w-md text-[13px] leading-7 text-[#727d80]">
            Something interrupted the connection to our
            product service. Please try again, or return to
            the shop and continue browsing.
          </p>
